...
public class BlockRainbowCraftingTable extends Block {
   public BlockRainbowCraftingTable(String name) {
      super(Material.WOOD);
   ...
   public static class InterfaceCraftingTable implements IInteractionObject {
      ...
      public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
         return new InterfaceCraftingTable.ContainerCraftingTable(playerInventory, this.world, this.position);
      }
      ...
      public static class ContainerCraftingTable extends ContainerWorkbench {
         ...
         public boolean canInteractWith(EntityPlayer playerIn) {
            if (!(this.world.getBlockState(this.pos).getBlock() instanceof BlockRainbowCraftingTable))
               return false;
